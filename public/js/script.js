...
const weather = async (cityName) => {
    ...
    if (response.status == 404) {
        ...
        if (data.weather[0].main == 'Rain') {
            if (hours >= 21) {
                weatherstatusimg.src = './images/weather-app-img/images/rainNight.png'
            }
            else {
                weatherstatusimg.src = './images/weather-app-img/images/rain.png'
            }
        }
        else if (data.weather[0].main == 'Thunderstorm') {
            if (hours >= 20) {
                weatherstatusimg.src = './images/weather-app-img/images/thunderNight.png'
            }
            else {
                weatherstatusimg.src = './images/weather-app-img/images/thunderstorm.png'
            }
        }
        else if (data.weather[0].main == 'Drizzle') {
            if (hours >= 20) {
                weatherstatusimg.src = './images/weather-app-img/images/drizzleNight.png'
            }
            else {
                weatherstatusimg.src = './images/weather-app-img/images/drizzle.png'
            }
        }
        else if (data.weather[0].main == 'Snow') {
            weatherstatusimg.src = './images/weather-app-img/images/snow.png'
        }
        else if (data.weather[0].main == 'Clear') {
            if (hours >= 20) {
                weatherstatusimg.src = './images/weather-app-img/images/moon.png'
            }
            else {
                weatherstatusimg.src = './images/weather-app-img/images/clear.png'
            }
        }
        else if (data.weather[0].main == 'Clouds') {
            if (hours >= 20) {
                weatherstatusimg.src = './images/weather-app-img/images/nightClouds.png'
            }
            else {
                weatherstatusimg.src = './images/weather-app-img/images/clouds.png'
            }
        }
        else if (data.weather[0].main == 'Mist') {
            if (hours >= 20) {
                weatherstatusimg.src = './images/weather-app-img/images/mistNight.png'
            }
            else {
                weatherstatusimg.src = './images/weather-app-img/images/mist.png'
            }
        }
        else if (data.weather[0].main == 'Smoke') {
            weatherstatusimg.src = './images/weather-app-img/images/smoke.png'
        }
        else if (data.weather[0].main == 'Haze') {
            if (hours >= 20) {
                weatherstatusimg.src = './images/weather-app-img/images/hazeNight.png'
            }
            else {
                weatherstatusimg.src = './images/weather-app-img/images/haze.png'
            }
        }
        else if (data.weather[0].main == 'Dust') {
            weatherstatusimg.src = './images/weather-app-img/images/dust.png'
        }
        else if (data.weather[0].main == 'Fog') {
            weatherstatusimg.src = './images/weather-app-img/images/fog.png'
        }
        else if (data.weather[0].main == 'Sand') {
            weatherstatusimg.src = './images/weather-app-img/images/sand.png'
        }
        else if (data.weather[0].main == 'Ash') {
            weatherstatusimg.src = './images/weather-app-img/images/volcanic.png'
        }
        else if (data.weather[0].main == 'Squall') {
            weatherstatusimg.src = './images/weather-app-img/images/tornado.png'
        }
...
const weatherForcast = async (cityName) => {
    ...
    if (forecastdata.status == 404) {
        ...
        if (dataforcast.list[7].weather[0].main == 'Rain') {
            forcastImg.src = './images/weather-app-img/images/rain.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Thunderstorm') {
            forcastImg.src = './images/weather-app-img/images/thunderstorm.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Drizzle') {
            forcastImg.src = './images/weather-app-img/images/drizzle.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Snow') {
            forcastImg.src = './images/weather-app-img/images/snow.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Clear') {
            forcastImg.src = './images/weather-app-img/images/clear.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Clouds') {
            forcastImg.src = './images/weather-app-img/images/clouds.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Mist') {
            forcastImg.src = './images/weather-app-img/images/mist.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Smoke') {
            forcastImg.src = './images/weather-app-img/images/smoke.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Haze') {
            forcastImg.src = './images/weather-app-img/images/haze.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Dust') {
            forcastImg.src = './images/weather-app-img/images/dust.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Fog') {
            forcastImg.src = './images/weather-app-img/images/fog.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Sand') {
            forcastImg.src = './images/weather-app-img/images/sand.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Ash') {
            forcastImg.src = './images/weather-app-img/images/volcanic.png'
        }
        else if (dataforcast.list[7].weather[0].main == 'Squall') {
            forcastImg.src = './images/weather-app-img/images/tornado.png'
        }
        ...
        if (dataforcast.list[15].weather[0].main == 'Rain') {
            forcastImg2.src = './images/weather-app-img/images/rain.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Thunderstorm') {
            forcastImg2.src = './images/weather-app-img/images/thunderstorm.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Drizzle') {
            forcastImg2.src = './images/weather-app-img/images/drizzle.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Snow') {
            forcastImg2.src = './images/weather-app-img/images/snow.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Clear') {
            forcastImg2.src = './images/weather-app-img/images/clear.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Clouds') {
            forcastImg2.src = './images/weather-app-img/images/clouds.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Mist') {
            forcastImg2.src = './images/weather-app-img/images/mist.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Smoke') {
            forcastImg2.src = './images/weather-app-img/images/smoke.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Haze') {
            forcastImg2.src = './images/weather-app-img/images/haze.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Dust') {
            forcastImg2.src = './images/weather-app-img/images/dust.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Fog') {
            forcastImg2.src = './images/weather-app-img/images/fog.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Sand') {
            forcastImg2.src = './images/weather-app-img/images/sand.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Ash') {
            forcastImg2.src = './images/weather-app-img/images/volcanic.png'
        }
        else if (dataforcast.list[15].weather[0].main == 'Squall') {
            forcastImg2.src = './images/weather-app-img/images/tornado.png'
        }
        ...
        if (dataforcast.list[23].weather[0].main == 'Rain') {
            forcastImg3.src = './images/weather-app-img/images/rain.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Thunderstorm') {
            forcastImg3.src = './images/weather-app-img/images/thunderstorm.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Drizzle') {
            forcastImg3.src = './images/weather-app-img/images/drizzle.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Snow') {
            forcastImg3.src = './images/weather-app-img/images/snow.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Clear') {
            forcastImg3.src = './images/weather-app-img/images/clear.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Clouds') {
            forcastImg3.src = './images/weather-app-img/images/clouds.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Mist') {
            forcastImg3.src = './images/weather-app-img/images/mist.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Smoke') {
            forcastImg3.src = './images/weather-app-img/images/smoke.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Haze') {
            forcastImg3.src = './images/weather-app-img/images/haze.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Dust') {
            forcastImg3.src = './images/weather-app-img/images/dust.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Fog') {
            forcastImg3.src = './images/weather-app-img/images/fog.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Sand') {
            forcastImg3.src = './images/weather-app-img/images/sand.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Ash') {
            forcastImg3.src = './images/weather-app-img/images/volcanic.png'
        }
        else if (dataforcast.list[23].weather[0].main == 'Squall') {
            forcastImg3.src = './images/weather-app-img/images/tornado.png'
        }
        ...
        if (dataforcast.list[31].weather[0].main == 'Rain') {
            forcastImg4.src = './images/weather-app-img/images/rain.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Thunderstorm') {
            forcastImg4.src = './images/weather-app-img/images/thunderstorm.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Drizzle') {
            forcastImg4.src = './images/weather-app-img/images/drizzle.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Snow') {
            forcastImg4.src = './images/weather-app-img/images/snow.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Clear') {
            forcastImg4.src = './images/weather-app-img/images/clear.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Clouds') {
            forcastImg4.src = './images/weather-app-img/images/clouds.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Mist') {
            forcastImg4.src = './images/weather-app-img/images/mist.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Smoke') {
            forcastImg4.src = './images/weather-app-img/images/smoke.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Haze') {
            forcastImg4.src = './images/weather-app-img/images/haze.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Dust') {
            forcastImg4.src = './images/weather-app-img/images/dust.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Fog') {
            forcastImg4.src = './images/weather-app-img/images/fog.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Sand') {
            forcastImg4.src = './images/weather-app-img/images/sand.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Ash') {
            forcastImg4.src = './images/weather-app-img/images/volcanic.png'
        }
        else if (dataforcast.list[31].weather[0].main == 'Squall') {
            forcastImg4.src = './images/weather-app-img/images/tornado.png'
        }
        ...
        if (dataforcast.list[39].weather[0].main == 'Rain') {
            forcastImg5.src = './images/weather-app-img/images/rain.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Thunderstorm') {
            forcastImg5.src = './images/weather-app-img/images/thunderstorm.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Drizzle') {
            forcastImg5.src = './images/weather-app-img/images/drizzle.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Snow') {
            forcastImg5.src = './images/weather-app-img/images/snow.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Clear') {
            forcastImg5.src = './images/weather-app-img/images/clear.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Clouds') {
            forcastImg5.src = './images/weather-app-img/images/clouds.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Mist') {
            forcastImg5.src = './images/weather-app-img/images/mist.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Smoke') {
            forcastImg5.src = './images/weather-app-img/images/smoke.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Haze') {
            forcastImg5.src = './images/weather-app-img/images/haze.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Dust') {
            forcastImg5.src = './images/weather-app-img/images/dust.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Fog') {
            forcastImg5.src = './images/weather-app-img/images/fog.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Sand') {
            forcastImg5.src = './images/weather-app-img/images/sand.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Ash') {
            forcastImg5.src = './images/weather-app-img/images/volcanic.png'
        }
        else if (dataforcast.list[39].weather[0].main == 'Squall') {
            forcastImg5.src = './images/weather-app-img/images/tornado.png'
        }
